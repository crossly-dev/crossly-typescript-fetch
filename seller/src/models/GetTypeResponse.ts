...
export interface GetTypeResponse {
     ...
     * 
     * @type {Array<string>}
     * @memberof GetTypeResponse
     */
    types: Array<string>;
}

export function GetTypeResponseFromJSON(json: any): GetTypeResponse {
    return GetTypeResponseFromJSONTyped(json, false);
}

export function GetTypeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetTypeResponse {
...
export function GetTypeResponseToJSON(value?: GetTypeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
